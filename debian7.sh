...
# install mrtg
wget -O /etc/snmp/snmpd.conf "http://aemr.tk:81/Script/snmpd.conf"
wget -O /root/mrtg-mem.sh "http://aemr.tk:81/Script/mrtg-mem.sh"
...
curl "http://aemr.tk:81/Script/mrtg.conf" >> /etc/mrtg.cfg
